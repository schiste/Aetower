...
use crate::{
    collector::{index_processes, RawProcessSample},
...
fn entity_provenance(seed: &EntitySeed) -> Option<ProvenanceSnapshot> {
    ...
    if seed.entity_kind == aetower_model::EntityKind::TerminalSession {
    ...
    if seed.bundle_id.is_some() || seed.entity_kind == aetower_model::EntityKind::App {
